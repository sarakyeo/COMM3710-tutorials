...
## Introduction
In this tutorial, you will learn how to use R to accomplish the following:

1. Open a help page in R
...
### A note about `mpg`
Note that I have already loaded the `ggplot2` package for you. On your own computer, you will first have to install and load `ggplot2` in R. To do so, follow the instructions in this [section of COMM 3710: Getting Started with R](https://sarakyeo.github.io/COMM-3710-bookdown/docs/start.html#packages).
...
### Your turn
*Write R code to subset the data by manufacturer (`manufacturer`). Examine the highway mileage (`hwy`) of Toyotas by running a frequency distribution.*

```{r student-sub, exercise=TRUE}

```

```{r student-sub-solution}
